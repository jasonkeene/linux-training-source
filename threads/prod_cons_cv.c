...
producer(void *arg)
{
    ...
    /* 'prodDone' will be set true when all units have been produced. This
       causes the loop below to terminate--after unlocking the mutex. */
...
consumer(void *arg)
{
    ...
    /* 'consDone' will be set true when all units have been consumed. This
       causes the loop below to terminate--after unlocking the mutex. */
