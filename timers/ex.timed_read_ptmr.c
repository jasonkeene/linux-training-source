...
main(int argc, char *argv[])
{
    ...
    ssize_t numRead;
    int savedErrno;
    struct sigevent sev;        /* Specifies notification mechanism when
                                   calling timer_create() */
    timer_t tid;                /* Timer ID returned by timer_create() */
    struct itimerspec its;      /* Timer value and interval for
                                   timer_settime() */
